package garciamaciel.sebastian.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import garciamaciel.sebastian.myfeelings.utilities.Emociones
import garciamaciel.sebastian.myfeelings.utilities.JSONFile
import org.json.JSONArray
import org.json.JSONException
import android.util.Log
import android.widget.Toast
import garciamaciel.sebastian.myfeelings.utilities.CustomBarDrawable
import garciamaciel.sebastian.myfeelings.utilities.CustomCircleDrawable
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria() {
        ...
        if (verySad > happy && verySad > neutral && verySad > sad && sad < veryHappy) {
